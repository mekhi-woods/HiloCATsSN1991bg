...
class sneObj:
    ...
    def __init__(self, source: str, path: str):
        ...
        if source == 'empty' or len(path) == 0:
        ...
        elif source in ['atlas-91bg','atlas-norm', 'csp', 'ztf'] and os.path.exists(path):
            ...
            # Extra details
            self.origin = source
            self.path = f"n_classes/{source}/{source}_{self.objname}_class.txt"
